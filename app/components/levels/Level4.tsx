...
export default function Level4({ onComplete, onHome }: Level4Props) {
  ...
  const [gameState, setGameState] = useState<"idle" | "playing" | "scored">(
    "idle"
  );
      ...
      const interval = setInterval(() => {
        setPosition((prevPosition) => {
          ...
          const maxPosition =
            ...
            (movingDivRef.current?.clientWidth || 0);
        ...
        setPosition4((prevPosition) => {
          ...
          const maxPosition =
            (containerRef.current?.clientWidth || 0) -
            (movingDivRef4.current?.clientWidth || 0);
        ...
        setPosition5((prevPosition) => {
          ...
          const maxPosition =
            (containerRef.current?.clientWidth || 0) -
            (movingDivRef5.current?.clientWidth || 0);
    ...
    <div className="w-full max-w-2xl mx-auto min-h-screen flex flex-col justify-center">
      ...
      <div className="mb-4 text-center">
        ...
        {gameState === "scored" && score && (
          <p>
            Your score: {score[0]}% ({score[1]}px from center)
          </p>
        )}
      </div>
      <div ref={containerRef} className="relative h-16 bg-gray-200 mb-4">
        <div
          ref={movingDivRef}
        ...
        <div
          ...
          style={{
            transform: `translateX(${containerRef.current?.clientWidth ? containerRef.current.clientWidth - 64 - position2 : 0}px)`,
          }}
        />
        <div
          ref={movingDivRef3}
          ...
          style={{
            transform: `translateX(${containerRef.current?.clientWidth ? containerRef.current.clientWidth - 128 - position3 : 0}px)`,
          }}
        />
        <div
          ref={movingDivRef4}
      ...
      <div className="flex justify-center gap-4">
        ...
        {gameState === "playing" && <Button onClick={stopGame}>Stop</Button>}
        {gameState === "scored" && (
          <>
      ...
      <div className="mt-8 flex justify-center">
        {score && score[0] >= 95 ? (
          ...
          >
            <source src="/sounds/LEBRON.webm" type="video/webm" />
